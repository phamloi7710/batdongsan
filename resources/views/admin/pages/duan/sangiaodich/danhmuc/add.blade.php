@section('title')
Thêm Mới Danh Mục Sàn Giao Dịch
@stop
...
<div class="right_col" role="main">
	<div class="x_panel">
        <div class="x_title">
            <h2>Thêm Mới Danh Mục Sàn Giao Dịch </h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <br />
            <form method="POST" action="{{route('postAddDanhMucSanGiaoDich')}}" class="form-horizontal form-label-left">
