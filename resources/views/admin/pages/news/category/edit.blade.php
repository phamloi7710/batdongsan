...
<div class="right_col" role="main">
	<div class="x_panel">
        <div class="x_title">
            <h2>Chỉnh Sửa Danh Mục Tin Tức </h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <br />
            <form method="POST" action="{{route('postEditNewsCategories',['slug'=>$category->slug,'id'=>$category->id])}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
