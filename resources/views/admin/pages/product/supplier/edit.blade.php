@section('title')
{{trans('action.edit')}} {{trans('general.supplier')}} | {{trans('general.siteName')}}
@stop
...
<div class="right_col" role="main">
    <div class="x_panel">
        <div class="x_title">
            <h2>{{trans('action.edit')}} {{trans('general.supplier')}}</h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <br />
            <form method="POST" action="{{route('postEditSupplier',['id'=>$supplier->id])}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
    		  <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">{{trans('general.title')}}
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="txtTitle" value="{{$supplier->title}}" type="text" class="form-control" required="required">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <select name="sltLang" class="form-control">
                            ...
                            <option value="{{$lang->code}}" @if($supplier->lang_code==$lang->code) selected @endif>{{$lang->title}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <select name="sltCate" class="form-control">
                            ...
                            <option value="{{$cates->id}}" @if($supplier->cate_id==$cates->id) selected @endif>{{$cates->title}}</option>
                            @endforeach
                        </select>
                        @if($errors->has('txtCode'))
                            <p style="color:red; float:left">{{$errors->first('txtCode')}}</p>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea name="description" id="ckeditor">{{$supplier->description}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1 col-sm-1 col-xs-12">
                        <input value="{{$supplier->sort}}" name="txtSort" type="number" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="radio radio-primary">
                            <input type="radio" name="status" id="radio1" value="active" @if($supplier->status=='active') checked @endif>
                            <label for="radio1">
                                {{trans('general.active')}}
                            </label>
                        </div>
                        <div class="radio radio-primary">
                            <input type="radio" name="status" id="radio2" value="inActive" @if($supplier->status=='inActive') checked @endif>
                            <label for="radio2">
                ...
                <div class="form-group">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <button type="submit" class="btn btn-success">{{trans('action.update')}}</button>
                    </div>
                </div>
            </form>
        </div>
