@section('title')
{{trans('action.addNew')}} {{trans('general.category')}} | {{trans('general.siteName')}}
@stop
...
<div class="right_col" role="main">
    <div class="x_panel">
        <div class="x_title">
            <h2>{{trans('action.addNew')}} {{trans('general.category')}}</h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <br />
            <form method="POST" action="{{route('postAddCategory')}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
