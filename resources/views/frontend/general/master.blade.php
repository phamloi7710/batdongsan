                        ...
                        <div class="flexslider slideshow-content" id="bannerheaderhome" ng-controller="moduleController" ng-init="initSlideshowController('Slideshows')">
                            <ul class="slides">
                                <li ng-repeat="item in Slideshows">
                                    ...
                                    <img src="http://runecom12.runtime.vn/Uploads/shop107/images/slide-one.jpg" alt="ten anh"/>
                                    </a>
                                </li>
                                <li ng-repeat="item in Slideshows">
                                    <a title="tieu de" href="link">
                                    <img src="http://runecom24.runtime.vn/Uploads/shop148/images/slider/banner5.jpg" alt="ten anh"/>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-12">
                                            ...
                                            <div class="project-item-box fixheight" ng-repeat="item in ProjectNewSlides">
                                                <div class="project-item project-slide-resize">
                                                    ...
                                                    <div class="image image-resize">
                                                        ...
                                                        <span class="ribbon">@{{it.Serial}}</span>
                                                    </div>
                            ...
                            <script type="text/javascript">
                                ...
                                [
                                    {
                                        "Id": 5,
                                        "Code": "can-ho-sunview-town-thu-duc",
                                        "Name": "Căn Hộ Sunview Town-Thủ Đức",
                                        "Image": "{{asset('')}}/assets/frontend/uploads/shop107/images/product/property-04-244x163.jpg",
                                        "ImageThumbnai": "{{asset('')}}/assets/frontend/uploads/shop107/images/product/property-04-244x163.jpg",
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-12 project-resize project-item-box">
                                            <div class="project-item">
                                                ...
                                                <div class="image image-resize">
                                                    ...
                                                    <img src="{{asset('')}}/assets/frontend/uploads/shop107/images/product/property-04-244x163.jpg" class="img-responsive" />
                                                    </a>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12 project-resize project-item-box">
                                            <div class="project-item">
                                                ...
                                                <div class="image image-resize">
                                                    ...
                                                    <img src="{{asset('')}}/assets/frontend/uploads/shop107/images/product/property-08-244x163.jpg" class="img-responsive" />
                                                    </a>
                                                    <span class="ribbon"></span>
                                                </div>
                                                <div class="description">
                                                    <p>
                                                        Sở hữu đất nền sổ đỏ tại Đồng Nai - dự án Gold Hill Center chỉ với 70 triệu thanh toán đợt 1, góp 7triệu/tháng. Tặng ngay 2 lượng vàng SJC khi ký hợp đồng. Phần còn lại được trả chậm 0% lãi suất từ 3, 6, 30 tháng
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12 project-resize project-item-box">
                                            <div class="project-item">
                                                ...
                                                <div class="image image-resize">
                                                    ...
                                                    <img src="{{asset('')}}/assets/frontend/uploads/shop107/images/product/property-10-244x163.jpg" class="img-responsive" />
                                                    </a>
                                                    <span class="ribbon"></span>
                                                </div>
                                                <div class="description">
                                                    <p>
                                                        Căn hộ trung tâm Thủ Đức - Chỉ cần có 399 triệu, bạn sở hữu ngay căn hộ mặt tiền đường Lê Văn Chí - một vị trí đẹp nhất quận Thủ Đức, Emerald Apartment tọa lạc ngay khu vực có vị trí giao thông rất thuận lợi ngay ngã tư Thủ Đức, Hỗ trợ vay đến 20 năm lãi suất 0.9%
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12 project-resize project-item-box">
                                            <div class="project-item">
                                                ...
                                                <div class="image image-resize">
                                                    ...
                                                    <img src="{{asset('')}}/assets/frontend/uploads/shop107/images/product/apartment-b-244x163.jpg" class="img-responsive" />
                                                    </a>
                                                    <span class="ribbon"></span>
                                                </div>
                                                <div class="description">
                                                    <p>
                                                        Sở hữu căn hộ Tân Phú - Topaz garden giá chỉ 12.8 triệu/m2. Vị trí trung tâm chỉ cách Đầm Sen 1km. Diện tích từ 64m2, gần chợ, bệnh viện, trường học. Tiện ích cao cấp, thuận tiện đi lại với các quận như Tân Bình, Quận 10, 11, quận 1... Liên hệ : 0914.66.88.15
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12 project-resize project-item-box">
                                            <div class="project-item">
                                                ...
                                                <div class="description">
                                                    <p>
                                                        Cách trung tâm Quận 1 gần 5 Km và chỉ mất khoảng 15 phút để tới sân bay quốc tế Tân Sơn nhất..
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12 project-resize project-item-box">
                                            <div class="project-item">
                                                ...
                                                <div class="description">
                                                    <p>
                                                        Morning Star Plaza hội tụ tất cả các tiện ích tốt nhất cho một phong cách sống thượng lưu.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!--End-->
                            <script type="text/javascript">
                                window.Partners = [{"Id":41,"ShopId":108,"Name":"ssd","Link":"#","Logo":"{{asset('')}}/assets/frontend/uploads/shop107/images/partner/logo-1.png","Index":1,"Inactive":false},{"Id":42,"ShopId":108,"Name":"22","Link":"#","Logo":"{{asset('')}}/assets/frontend/uploads/shop107/images/partner/logo-2.png","Index":2,"Inactive":false},{"Id":43,"ShopId":108,"Name":"edg","Link":"#","Logo":"{{asset('')}}/assets/frontend/uloads/shop107/images/partner/logo-3.png","Index":3,"Inactive":false},{"Id":44,"ShopId":108,"Name":"Ff","Link":"#","Logo":"{{asset('')}}/assets/frontend/uploads/shop107/images/partner/logo-4.png","Index":4,"Inactive":false}];
                            </script>                        
                        </div>
                    </div>
                </div>
